-- the convention of making KEY WORDS ALL CAPS 
-- vs
-- variables lowercase really does make it easier to read
CREATE TABLE products (
    id INTEGER PRIMARY KEY,
    name TEXT,
    -- checks are very useful data integrity
    -- so essentially everything is to prevent weird data insertions...
